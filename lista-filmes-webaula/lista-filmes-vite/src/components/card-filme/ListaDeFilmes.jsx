...
// lista_filmes.forEach((item, i) => myArray.push(<li key={item+1}>{item}</li>));
...
{/* <CardFilme titulo='Até o Último Homem' rate='9.0'/>
<CardFilme titulo='Homem Formiga' rate='6.3'/>
<CardFilme titulo='Lugar Silencioso' rate='9.8'/> */}